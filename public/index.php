...
$app->map('/panelAdmin', function() use ($app) {
            if (usuario_logeado() && ORM::for_table('usuario')->where('nick', $_SESSION['logeo'])->find_one()->es_admin == 1) {
                $dato = 10;
                $datos = null;
                $fecha1 = null;
                $fecha2 = null;
                    ...
                    case "POST":
                        if (isset($_POST['muestranoticias'])) {
                            ...
                            if (isset($_POST['nombrematerial']) && isset($_POST['sinopsismaterial']) &&
                                ...
                                $correcto = aceptar_material($_POST['nombrematerial'], $_POST['sinopsismaterial'], $_POST['aniomaterial'], $_POST['tipomaterial'], $_POST['generomaterial'], $_POST['id']);
                            }
                            if ($correcto == false)
...
$app->post('/busquedausuario/:num', function($num) use ($app) {
            if (usuario_logeado()) {
                ...
                if (isset($_POST['busquedausuario']) && strlen($_POST['busquedausuario']) > 0 && isset($_POST['filtrado'])) {
                    ...
                    $datosQueGuardar[0] = $_POST['busquedausuario'];
                    ...
                    case "POST":
                        if (isset($_POST['guardar'])) {
                            ...
                            if (isset($_POST['cnombre']) && isset($_POST['capellido']) &&
                                    isset($_POST['cdescripcion']) && isset($_POST['claveantigua']) && isset($_POST['clavenueva']))
                                $edit = editar_usuario($_POST['cnombre'], $_POST['capellido'], $_POST['cdescripcion'], $_POST['claveantigua'], $_POST['clavenueva']);
                            else
                                $edit = false;
                        }
                    ...
                    case "POST":
                        if (isset($_POST['publicar'])) {
                            if (isset($_POST['nombrematerial']) && isset($_POST['sinopsismaterial']) &&
                                ...
                                $verificar = publicar_material($nombreMaterial, $sinopsisMaterial, $anioMaterial, $tipoMaterial, $generoMaterial);
                            } else {
                                $verificar = false;
                                $nombreMaterial = "";
                                $sinopsisMaterial = "";
