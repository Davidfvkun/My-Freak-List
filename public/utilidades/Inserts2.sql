...
insert into material_usuario(usuario_id, material_id, estado, puntuacion, vista_en, comentario, capitulo_por_el_que_vas) 
		values (1,2,2, 8, 'Vista en Random David 2', 'Comentario random David 2', 1);
insert into material_usuario(usuario_id, material_id, estado, puntuacion, vista_en, comentario, capitulo_por_el_que_vas) 
		values (1,3,3, 7, 'Vista en Random David 3', 'Comentario random David 3', 1);
insert into material_usuario(usuario_id, material_id, estado, puntuacion, vista_en, comentario, capitulo_por_el_que_vas) 
		values (1,4,2, 4, 'Vista en Random David 4', 'Comentario random David 4', 1);
insert into material_usuario(usuario_id, material_id, estado, puntuacion, vista_en, comentario, capitulo_por_el_que_vas) 
		values (1,5,3, 2, 'Vista en Random David 5', 'Comentario random David 5', 1);
insert into material_usuario(usuario_id, material_id, estado, puntuacion, vista_en, comentario, capitulo_por_el_que_vas) 
		values (1,6,1, 8, 'Vista en Random David 6', 'Comentario random David 6', 1);
insert into material_usuario(usuario_id, material_id, estado, puntuacion, vista_en, comentario, capitulo_por_el_que_vas) 
		values (1,7,2, 7, 'Vista en Random David 7', 'Comentario random David 7', 1);
insert into material_usuario(usuario_id, material_id, estado, puntuacion, vista_en, comentario, capitulo_por_el_que_vas) 
...
insert into material_usuario(usuario_id, material_id, estado, puntuacion, vista_en, comentario, capitulo_por_el_que_vas) 
		values (1,10,3, 8, 'Vista en Random David 10', 'Comentario random David 10', 1);
insert into material_usuario(usuario_id, material_id, estado, puntuacion, vista_en, comentario, capitulo_por_el_que_vas) 
		values (1,11,2, 9, 'Vista en Random David 11', 'Comentario random David 11', 1);
insert into material_usuario(usuario_id, material_id, estado, puntuacion, vista_en, comentario, capitulo_por_el_que_vas) 
		values (1,12,1, 8, 'Vista en Random David 12', 'Comentario random David 12', 1);
insert into material_usuario(usuario_id, material_id, estado, puntuacion, vista_en, comentario, capitulo_por_el_que_vas) 
